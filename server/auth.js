      ...
      if (session) {
        ...
        if (user) {
          req.user = {
            ...
            /*
             * هل اختار بلده بنفسه؟ عليه تُبنى عملةُ السعر وطريقةُ الدفع —
             * وبلدٌ افترضناه عنه في ترحيلٍ قديم كان يُري من هو خارج فلسطين
             * سعراً بالشيكل ومحفظةً لا تعنيه.
             */
            countryChosen: Boolean(user.countryChosenAt),
