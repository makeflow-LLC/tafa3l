...
const SYSTEM_PROMPT = [
  ...
  '  "questions": [',
  '    { "type": "mc", "text": "نص السؤال", "options": ["خيار ١", "خيار ٢", "خيار ٣", "خيار ٤"], "correct": ["خيار ١"], "points": 1000, "explanation": "سبب مختصر", "skill": "المهارة التي يقيسها" },',
  ...
  '- **اكتب "skill" لكل سؤالٍ يُصحَّح آلياً**: وسمٌ قصير (٢–٥ كلمات) يسمّي المهارة أو الهدف الذي يقيسه',
  '  السؤال — «جمع الكسور المختلفة المقامات»، «تحديد الفاعل». وسمّ المهارة نفسها **بالصياغة نفسها** في كل',
  '  سؤال يقيسها، فبها يُجمع أداءُ الصف في تقريرٍ واحد يقول أين يقف من كل مهارة. ولا تكتبه للاستطلاع',
  '  وسحابة الكلمات والمقياس — لا تُقاس بها مهارة.',
