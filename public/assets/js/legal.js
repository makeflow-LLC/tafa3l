(function (global) {
   ...
   * لا تُحفظ إطلاقاً، ولا نبيع شيئاً، وأداةُ القياس الوحيدة عندنا لا يصلها
   * نصٌّ من الشاشة. أي تغيير في سلوك التطبيق يجب أن ينعكس هنا — وإضافةُ
   * أداةٍ خارجية تغييرٌ في السلوك قبل أن تكون سطراً في هذه الصفحة.
   */
  ...
  const DOCS = {
    privacy: {
      ar: {
        ...
        intro: 'باختصار: لا نحتفظ بإجابات الطلاب، ولا نبيع أي بيانات، ولا يصل أحداً نصٌّ ممّا على شاشتك. وهذه التفاصيل.',
        ...
        sections: [
            ...
            blocks: [
              {
                ul: [
                  ...
                  '<strong>لا إعلانات ولا بيع بيانات</strong>. ونستعمل أداةَ قياسٍ واحدة (Microsoft Clarity) لنعرف أين يتعثّر المعلّم في الواجهة — <strong>وكلُّ نصٍّ على الشاشة مُقنَّعٌ قبل أن يخرج</strong>: لا تصلها أسماء الطلاب ولا إجاباتهم ولا الرموز الشخصية ولا أرقام الهواتف، بل مواضعُ النقر وأشكالُ الصفحة (البند ٤).',
                ],
              },
            ],
          },
            ...
            blocks: [
              { p: 'الشيء الدائم الوحيد هو <strong>حساب المعلّم ومحتواه هو</strong>، وباختياره:' },
              {
                ul: [
                  ...
                  '<strong>ملفات تعريف الارتباط</strong>: كعكة جلسة واحدة تُبقيك مسجّلاً، وكعكة مؤقتة أثناء تسجيل الدخول لحماية العملية، وكعكتا قياسٍ من Microsoft Clarity (<code>_clck</code> و<code>_clsk</code>) تميّزان الزيارة عن التي قبلها. لا كعكات إعلانية ولا بيع لأي منها.',
                ],
              },
              {
          ...
          },
          {
            ...
            blocks: [
              ...
              { p: 'ولتحسين الواجهة نفسها: أين يُضغط، وأين يتعثّر المعلّم، وأي شاشةٍ تُغادَر بسرعة — من قياسٍ مُقنَّعِ النصّ لا من محتواك.' },
              { p: 'لا نستعمل بياناتك لأي غرض آخر — لا تسويق ولا إعلان ولا بناء ملفات اهتمامات، ولا نربط القياس باسمك ولا ببريدك.' },
            ],
          },
          {
              ...
              { p: 'لا نبيع بياناتك ولا نشاركها لأغراض تجارية. تمرّ بياناتك بمزوّدي خدمة تقنيين فقط، كلٌّ في حدود دوره:' },
              {
                table: {
                  ...
                  rows: [
                    ...
                    ['Microsoft Clarity', 'قياس استعمال الواجهة', 'مواضع النقر والتمرير وشكل الصفحة ونوع الجهاز — <strong>بلا أي نصّ من الشاشة</strong>'],
                  ],
                },
              },
              { muted: 'مساعد الذكاء الاصطناعي لا يُستدعى إلا حين تفتحه وتكتب فيه، ولا تُرسَل إليه أي بيانات طلاب.' },
              { muted: 'وقياس Clarity يُرسل الأشكال لا الكلمات: النصوص تُستبدل بعلاماتٍ مبهمة قبل أن تغادر جهازك، فتظهر الجلسة عندنا هيكلاً ونقراتٍ لا محتوى. وتستطيع إيقافه عنك من إعدادات متصفّحك أو بصفحة الانسحاب لدى Microsoft.' },
            ],
          },
          {
            title: '٥. حقوقك',
