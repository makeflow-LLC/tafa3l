      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>وقت الإجابة اختياري ⏱️</strong>: الافتراضي <em>بلا مؤقّت</em> فيجيب الطالب على راحته، وإن أردت التوقيت فهو <em>وقتٌ واحد بالثواني يسري على كل الأسئلة</em> — لا رقمٌ تحت كل سؤال. وأسئلتك تُكتب واحداً واحداً كالمعالج: تكتب السؤال ثم «التالي»، فلا تزدحم الشاشة.' },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>Answer time is optional ⏱️</strong>: the default is <em>no timer</em>, so students answer at their own pace; if you do want timing it is <em>one number of seconds applied to every question</em> — not a figure under each one. And you write your questions one at a time like a wizard: write a question, press “Next”, so the screen never gets crowded.' },
