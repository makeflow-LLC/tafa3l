      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>وقت الإجابة اختياري ⏱️</strong>: اختر <em>وقتاً لكل سؤال</em> على حدة، أو <em>وقتاً واحداً</em> بالثواني يسري على كل الأسئلة، أو <em>بلا مؤقّت</em> فيجيب الطالب على راحته.' },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>Answer time is optional ⏱️</strong>: pick <em>a time per question</em>, or <em>one time in seconds</em> applied to every question, or <em>no timer</em> so students answer at their own pace.' },
