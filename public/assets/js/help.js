      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>اللعب بلا إنترنت 📥</strong>: يضغط الطالب «احفظها للّعب بلا إنترنت» فتُخزَّن داخل متصفّحه، ويفتح <em>صفحة اللعبة نفسها</em> بعدها ولو بلا اتصال فتعمل — في الحصّة التي ضعف فيها الواي فاي، أو في البيت. و<strong>لا يُنزَّل ملفٌّ إلى مجلّد التنزيلات</strong>، وهذا مقصود: اللعبة تبقى داخل الحماية نفسها ولا تخرج عن سيطرتك نسخةً حرّة. وإن أردتَ لعبتك على المنصّة وحدها فأزل علامة «اسمح بحفظها للّعب بلا إنترنت» عند الرفع.' },
