      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>🌙 الوضع الداكن</strong>: زرّ القمر/الشمس بجوار زرّ اللغة في كل صفحة. اختيارك يثبت بين الصفحات والزيارات. وشاشة الطالب وشاشة البروجكتر داكنتان افتراضاً (ألوانهما مبنيّة على أرضية داكنة، وقاعةٌ مضاءة لا تُقرأ فيها شاشة بيضاء) — لكن لك ولطلابك أن تقلبوها متى شئتم.' },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>Launching needs your account 🔐</strong>: sign in with Google in one tap — the activity is then yours, saved automatically under “My activities”, and carries your name on the reports. Your <em>students</em>, on the other hand, need no account and no app at all.' },
          ...
          blocks: [
            ...
            { h3: 'Running the class' },
            {
              ul: [
                ...
                '<strong>Three switches for what the learner sees</strong> in the activity settings: “Show the correct answer” (off: they see neither the right answer nor whether theirs was right), “Show the learner their result” (points or mark and rank — turn it off when you announce results yourself), and “Show other participants” (their count, the leaderboard and class results — off: each learner sees only themselves). You still see everything in your dashboard.',
