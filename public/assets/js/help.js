      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>الألعاب التفاعلية 🎮</strong>: عندك لعبة صمّمتها بنفسك أو بمساعدة الذكاء الاصطناعي؟ ارفعها من «ألعابي» كملف HTML واحد مكتفٍ بذاته (كل الشفرة والتنسيق داخله، حتى ٢ ميغابايت)، مع اسمها ومادّتها وصفوفها — واتركِ الصفوف فارغة إن كانت تصلح لكل المراحل. ستظهر في قسم «الألعاب» يبحث فيها المعلّمون والطلاب بالمادة أو الصف، ويلعبونها في المتصفّح بلا حساب، ويقيّمونها بالنجوم.' },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: '<strong>Interactive games 🎮</strong>: have a game you built yourself or with AI? Upload it from “My games” as a single self-contained HTML file (all code and styling inside it, up to 2 MB), with its name, subject and grades — leave the grades empty if it suits every stage. It appears in the Games section where teachers and students search by subject or grade, play it in the browser without an account, and rate it with stars.' },
