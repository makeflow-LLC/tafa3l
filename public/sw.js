...
const SHELL = ['/games.html', '/assets/css/app.css', '/assets/css/participant.css', '/assets/js/i18n.js', '/assets/js/theme.js', '/assets/js/common.js', '/assets/js/participant-ui.js', '/assets/js/footer.js', '/assets/js/games.js'];
